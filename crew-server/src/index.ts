...
import { ChannelManager, CHANNEL_PATTERNS, CHANNEL_PUBLIC_KEYS, IMS, IM_NAME, connectCard, missingChannelCreds, saveBotChannelCreds, wecomCallback, whatsappCallback, type Im } from './channels.ts';
