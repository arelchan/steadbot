...
/**
 * bot 跑在哪，决定了「交付」是什么意思。带令牌的那台是云机器（不是用户的电脑），本机那台就是用户
 * 自己的电脑——后者 localhost 是通的，前者永远不通。
 */
